...
You can switch languages using the drop-down menu above your editor, and the  variable may be
...
happens to be Welcome to 30 Days of Code!. If you do not print the variable's contents to stdout,
